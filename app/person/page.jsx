    ...
    <main className={styles.personPage}>
      ...
      <div className={styles.bio}>
        ...
        <p>
          ...
          <br/><br/>
          When I&rsquo;m not lost in <Link href="/developer">JavaScript debugging hell</Link>, I can usually be found working on new <Link href="/designer">designs</Link> or tinkering with some <Link href="/maker">project</Link>. But sometimes I get tired of doing those things and just hang out with my cat and my wife (in that order).
          <br/><br/>
